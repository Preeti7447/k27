        ...
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            ...
            <div onClick={()=>{
             ...
             onMouseEnter={() => {
                ...
                className='lg:h-12 h-8 bg-black relative lg:w-[16vw] w-40'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'> </div>
                <div className='relative h-full lg:px-8 px-5 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5'>
